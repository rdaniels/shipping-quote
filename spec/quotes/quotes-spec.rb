...
module ShippingQuote
  describe Shipping do
    ...
    #  it 'removed USPS Media Mail if all items are not shipCode ENV or weight > .81'
    #  it 'does not return when quote <= boxing charge'
    #
    ...
    #  end
    #  {:country=>"US", :street=>"1234 fake street", :province=>"FL", :city=>"Tampa", :postal_code=>"33609"}
    #  {:country=>"US", :province=>"FL", :city=>"Tampa", :postal_code=>"33609"}
    #end



    describe 'fedex shipping' do
